        ...
        <div className="Projects">
            <div className="content">
                ...
                <ProjectCard>
                    ...
                    <p>I implemented part of the most relevant reinforcement learning methods. Their functionality is demonstrated and compared to each other. This project can be used to find the right algorithm for a given problem as well as the best fitting hyperparameters. This can be found on my <u><a href="https://www.github.com/SeJV/ComparisonRLApproaches" target="_blank" rel="noreferrer">github</a></u>.</p>
